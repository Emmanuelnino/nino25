...
<div className='flex gap-2'>
                <div className='mr-4'>
                    ...
                    <svg className='h-6 w-6 mr-1 text-blue-400' xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
